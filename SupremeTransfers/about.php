...
<?php include 'includes/setup.inc.php'; ?>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Super Transfers Cancun- About Us</title>
				...
				<div class="overlay overlay-bg"></div>
					...
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Inicio </a>  <span class="lnr lnr-arrow-right"></span>  <a href="about.php"> About Us</a></p>
						</div>	
					</div>
				</div>
			</section>
