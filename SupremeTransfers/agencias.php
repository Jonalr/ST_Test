...
<?php include 'includes/setup.inc.php'; ?>
	...
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Super Transfers Cancun - Agencies</title>
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="agencias.php"> Agencias</a></p>
						</div>	
					</div>
				</div>
			</section>
