...
<?php include 'includes/setup.inc.php'; ?>
	...
	<head>
		...
		<body>	
				...
				<div class="container">				
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.php">Home</a>  <span class="lnr lnr-arrow-right"></span>  <a href="tours.php"> Tours</a></p>
						</div>	
					</div>
				</div>
			</section>
						...
						<div class="tab-content" id="myTabContent" style="padding: 0 0 0 15px; float: right;">
							<div style="width: 350px; height: 372px; background-color: #003464;" class="tab-pane fade show active" id="flight" role="tabpanel" aria-labelledby="flight-tab">		
								<form class="form-wrap">
									...
									<a style="background-color: #00b2f865" href="https://supremetransfers.btransfer.mx" class="primary-btn" onMouseover="this.style.background='#009bf5'" onMouseout="this.style.background='#00669f'">Get prices</a>									
								</form>	
							</div>
						</div>	
					</div>
				...
				<div class="container">
					<div class="justify-content-left" >
			 			<div class="text-justify">
							<h1 class="text-center">Today’s Hot Deals</h1>
			...
			<!-- Start hot-deal Area //Pequeño carrucel-->
