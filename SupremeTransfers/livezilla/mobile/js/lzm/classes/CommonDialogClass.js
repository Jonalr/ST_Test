...
CommonDialogClass.prototype.createAlertDialog = function(errorMessage, buttons, wide, dim, shadow) {
    ...
    if(wide)
        ...
        this.alertDialogWidth = Math.min(Math.round(wwidth * 0.9), 320);


    $('#test-lzm-alert-dialog').css({width: this.alertDialogWidth+'px'});

    var twHeight = $('#test-lzm-alert-dialog').height()+50;
...
CommonDialogClass.prototype.ChangePassword = function(_force) {
    ...
    lzm_commonDialog.createAlertDialog(bodyString, buttons,false,true,false);
...
CommonDialogClass.prototype.createPasswordChangeHtml = function(_force) {
    var myHtml = '<div id="change-password-inner" class="lzm-fieldset" data-role="none"><div>';
