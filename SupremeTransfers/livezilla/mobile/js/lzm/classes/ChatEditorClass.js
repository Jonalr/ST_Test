...
ChatEditorClass.prototype.init = function(loadedValue, caller, cpId, _regularPaste) {
...
ChatEditorClass.prototype.showHTML = function() {
    ...
    $('#editor-edit-html-'+this.Id).css('height',parseInt($('#edit-kb-html-'+this.Id+'-body').css('height').replace('px','')-56)+'px');
};
