...
LocalConfiguration.GetTicketAreaKey = function(){
    var area = $('#search-ticket').length && $('#search-ticket').val().length ? 'search' : CommunicationEngine.ticketFilterStatus+CommunicationEngine.ticketFilterPersonal+CommunicationEngine.ticketFilterGroup+CommunicationEngine.ticketFilterWatchList+CommunicationEngine.ticketFilterSubChannels+CommunicationEngine.ticketFilterSubStatus;
    if(!area.length)
        area = 'all';
