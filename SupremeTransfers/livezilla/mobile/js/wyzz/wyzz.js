    ...
    if (document.getElementById('wysiwyg' + _eId) != null)
    {
        ...
        if (lastSelection != null)
        {
            try
            {
                ...
                //console.log(pos);
                //console.log(lastSelection.getRangeAt(0).startContainer.parentNode);
                //console.log(lastSelection.getRangeAt(0).startContainer.parentNode.innerHTML);
    ...
    if (document.getElementById('wysiwyg' + _eId) != null)
    {
        ...
        if (sel != null)
        {
            try
            {
                ...
                console.log('SEARCH FOR:' + _replaceWord);
                console.log('REP WITH:' + _replaceWith);
...
function lz_he_insertHTML(html, n){
    ...
    /*
    var win = document.getElementById('wysiwyg' + n).contentWindow;
