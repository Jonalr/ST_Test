...
class VisitorChat extends VisitorBrowser
{
	...
	function SetValues($row)
	{
        ...
        $this->Activated = (($this->InternalActivation) ? CHAT_STATUS_ACTIVE : (/*(false && $this->InternalActivation) ? CHAT_STATUS_WAITING : */CHAT_STATUS_OPEN));
    ...
    function CreateArchiveEntry($_internalUser, $_visitor, $custom="", $etpl="", $_customsInTranscript=true, $pdm=null)
    {
        ...
        $code = "";
        if(isset($_visitor->Browsers[1]) && isset($_visitor->Browsers[1]->History[0]))
