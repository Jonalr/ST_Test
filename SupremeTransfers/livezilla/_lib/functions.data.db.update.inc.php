...
//RM op:websites_config
//RM op:websites_users
...
function up_7089_7090($_prefix,$_link,$_engine)
{
    ...
    $acc_de = "Lieber Kunde, dieser Chat wurde aufgrund von Inaktivität automatisch geschlossen.";
    $acc_en = "Dear customer, this chat was closed automatically due to inactivity.";
    $aco_de = "Ich bin leider momentan verhindert und werde Sie in Kürze per E-Mail kontaktieren. Dieser Chat wird automatisch geschlossen.";
